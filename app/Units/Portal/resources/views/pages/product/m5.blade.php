...
@push('svgs')
    @component('portal::svg.logos.logo-m5')@endcomponent
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 justify-items-center items-center">
                <div class="p-5">
                    <img alt="MM"
                         ...
                         src="{{ config('app.static_files_url') }}portal/img/produtos/m5-large.webp"
                         decoding="async"
                         width="750"
                         height="702"
                         class="w-full">
                ...
                <div class="flex-shrink-0 flex flex-col md:py-12">
                    <div class="pb-3 lg:pb-5">
                        <svg class="logo w-60 min-w-1/4 mb-6 transition-all duration-300"
                             viewBox="0 0 159 86">
                            <use x="0" y="0" class="fill-current" xlink:href="#logo-m5"></use>
                        </svg>
                        ...
                        <p class="mt-4">
                            <strong>Combustão mais rápida e uniforme </strong>
                        </p>
                        <p class="mt-4">
                            A composição perfeita para o mais alto desempenho
                        </p>
                        <p class="mt-4">
                            0 <strong>M5</strong> é um combustível que produz mais energia se comparado ao metanol graças aos seus
                            avançados aditivos de combustão. Além disso, oferece proteção superior contra o desgaste dos
                            componentes e máxima vaporização. Como resultado, o M5 oferece uma faixa mais ampla na
                            relações ar/combustível permitindo ajustes mais finos.
                        </p>
                        <p class="mt-4">
                            O <strong>combustível M5</strong> é projetado para corridas de arrancada.
                        </p>
                    </div>
